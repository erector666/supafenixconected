-- FENIX Construction Tracker Database Schema
...
-- Allow all authenticated users to read employees (for admin dashboard)
CREATE POLICY "Allow authenticated users to read employees" ON employees
    FOR SELECT USING (auth.role() = 'authenticated');

-- Allow authenticated users to insert employees (admin function)
CREATE POLICY "Allow authenticated users to insert employees" ON employees
    FOR INSERT WITH CHECK (auth.role() = 'authenticated');

-- Allow authenticated users to update employees (admin function)
CREATE POLICY "Allow authenticated users to update employees" ON employees
    FOR UPDATE USING (auth.role() = 'authenticated');

-- Allow authenticated users to delete employees (admin function)
